...
/// <summary>
/// Filters entities whose selected value is less than or equal to the provided value.
/// </summary>
public sealed class LessThanOrEqualSpecification<T, TKey>(Expression<Func<T, TKey>> selector, TKey value)
