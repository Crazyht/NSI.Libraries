...
/// <summary>
/// Filters entities whose selected string contains the given term.
/// </summary>
public sealed class ContainsSpecification<T>(Expression<Func<T, string?>> selector, string term, bool ignoreCase = true)
