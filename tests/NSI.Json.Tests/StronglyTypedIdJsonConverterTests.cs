...
/// <summary>
/// Tests for JSON serialization/deserialization of strongly-typed identifiers.
/// </summary>
/// <remarks>
/// <para>
/// Verifies correct handling for nullable/non-nullable properties, standalone values,
/// collections and dictionaries, as well as invalid and mismatched formats. Ensures
/// the <see cref="StronglyTypedIdJsonConverterFactory"/> preserves values and throws
/// appropriate exceptions on invalid inputs.
/// </para>
/// </remarks>
public class StronglyTypedIdJsonConverterTests {
  ...
  public void Given_ObjectWithNonNullableId_When_SerializedAndDeserialized_Then_OriginalValuesArePreserved() {
    ...
    var deserialized = JsonSerializer.Deserialize<NonNullablePropertyTestClass>(
      json,
  ...
  [InlineData(
    "{\"Id\":\"UserId-00000000-0000-0000-0000-000000000000\",\"Email\":\"test@test.com\"}",
    "00000000-0000-0000-0000-000000000000",
    "test@test.com"
  )]
  public void Given_JsonWithIdProperty_When_Deserialized_Then_PropertiesAreCorrectlyPopulated(
    ...
    // When
    var obj = JsonSerializer.Deserialize<NullablePropertyTestClass>(
      json,
      CachedJsonSerializerOptions
    );
    ...
    if (expectedGuid == null) {
      ...
      Assert.Equal(
        Guid.Parse(expectedGuid, CultureInfo.InvariantCulture),
        obj.Id.Value
      );
    }
  }
  ...
  public void Given_JsonWithInvalidIdFormat_When_Deserialized_Then_ThrowsJsonException() {
    // Given
    const string invalidJson = "{\"Id\":\"InvalidFormat\",\"Email\":\"test@test.com\"}";

    // When/Then
    var exception = Assert.Throws<JsonException>(
      () => JsonSerializer.Deserialize<NonNullablePropertyTestClass>(
        invalidJson,
        CachedJsonSerializerOptions
      )
    );
  ...
  public void Given_ObjectWithIntegerId_When_SerializedAndDeserialized_Then_OriginalValueIsPreserved() {
    ...
    var deserialized = JsonSerializer.Deserialize<IntegerIdContainer>(
      json,
      CachedJsonSerializerOptions
    );
  ...
  public void Given_ObjectWithStringId_When_SerializedAndDeserialized_Then_OriginalValueIsPreserved() {
    ...
    // When
    var json = JsonSerializer.Serialize(container, CachedJsonSerializerOptions);
    var deserialized = JsonSerializer.Deserialize<StringIdContainer>(
      json,
      CachedJsonSerializerOptions
    );
  ...
  public void Given_CollectionOfIds_When_SerializedAndDeserialized_Then_AllIdsArePreserved() {
    ...
    var deserialized = JsonSerializer.Deserialize<IdCollection>(
      json,
      CachedJsonSerializerOptions
    );
  ...
  public void Given_JsonWithWrongIdType_When_Deserialized_Then_ThrowsJsonException() {
    ...
    const string wrongTypeJson = "{\"Id\":\"IntegerId-123\",\"Email\":\"test@test.com\"}";
  ...
  public void Given_StandaloneId_When_SerializedAndDeserialized_Then_ValueIsPreserved() {
    ...
    var deserialized = JsonSerializer.Deserialize<UserId>(
      json,
      CachedJsonSerializerOptions
    );
  ...
  public void Given_DictionaryWithIdValues_When_SerializedAndDeserialized_Then_DictionaryIsPreserved() {
    ...
    // When
    var json = JsonSerializer.Serialize(container, CachedJsonSerializerOptions);
    var deserialized = JsonSerializer.Deserialize<DictionaryContainer>(
      json,
      CachedJsonSerializerOptions
    );
    ...
    Assert.Equal(
      container.UserMapping["user1"].Value,
      deserialized.UserMapping["user1"].Value
    );
    Assert.Equal(
      container.UserMapping["user2"].Value,
      deserialized.UserMapping["user2"].Value
    );
  }
  ...
  public void Given_JsonWithNonStringIdProperty_When_Deserialized_Then_ThrowsJsonException() {
    ...
    const string invalidTypeJson = "{\"Id\":123,\"Email\":\"test@test.com\"}";
  ...
  // ID types and containers used in tests
