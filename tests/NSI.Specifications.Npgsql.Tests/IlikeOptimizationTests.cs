...
/// <summary>
/// Integration tests verifying case-insensitive text specifications are rewritten to
/// PostgreSQL ILIKE patterns (Contains/StartsWith/EndsWith) when Npgsql optimizations
/// are registered.
/// </summary>
...
public sealed class IlikeOptimizationTests(PostgresFixture fx) {
  ...
  /// <summary>
  /// Verifies that Contains with ignoreCase=true is rewritten to ILIKE and returns rows.
  /// </summary>
  [Fact]
