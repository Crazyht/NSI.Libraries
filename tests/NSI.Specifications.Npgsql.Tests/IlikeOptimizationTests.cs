...
/// <summary>
/// Tests verifying translation of text specifications into ILIKE when using Npgsql provider.
/// </summary>
[Collection(PostgresCollection.CollectionName)]
/// <summary>
/// Integration tests ensuring that case-insensitive text specifications are rewritten
/// to PostgreSQL ILIKE patterns when optimizations are registered.
/// </summary>
