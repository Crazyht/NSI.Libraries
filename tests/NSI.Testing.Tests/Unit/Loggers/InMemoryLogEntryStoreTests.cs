...
namespace NSI.Testing.Tests.Unit.Loggers {
  ...
  public class InMemoryLogEntryStoreTests {
    ...
    [Fact]
    [SuppressMessage("Major Bug", "S6507:Blocks should not be synchronized on local variables", Justification = "Multithreading test can be parallize.")]
    ...
    [Fact]
    [SuppressMessage("Major Code Smell", "S2925:\"Thread.Sleep\" should not be used in tests", Justification = "")]
